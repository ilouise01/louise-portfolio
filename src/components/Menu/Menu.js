  ...
  return (
    <div className='menu'>
        <div className='menu-container'>
            <h2 style={{WebkitTextStrokeColor: darkTheme.Secondary, }} className='menu-link mons' onMouseEnter={menuhover} onMouseLeave={menuleave}><Link className='mons' to="/louise-portfolio" onClick={() => {openburger();menuclick();}} >HOME</Link><div className='h5parent'><div className='hr'><div className='hr-progress'></div></div><h5>01</h5></div></h2>
