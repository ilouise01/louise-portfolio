...
const FluidSimulation = () => {
  ...
  useEffect(() => {
    // Your WebGL code should go here, referencing 'canvasRef.current'.
    // You can copy and paste your existing WebGL code here.
...
function generateColor() {
    // Return a fixed color as an object
    return {
        r: 85   *    0.003,   // Red component (0 to 255)
        g: 85  *    0.003,     // Green component (0 to 255)
        b: 85  *    0.003,      // Blue component (0 to 255)
    };
}
